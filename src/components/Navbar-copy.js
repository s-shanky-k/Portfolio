        ...
        <nav className='navbar'>
            <div className='nav-container'>
                ...
                <li className='nav-item'>
                    <Link className='nav-links' to="aboutme" onClick={closeMobileMenu} smooth={true} duration={500} spy={true} exact='true' offset={0} activeClass='active'>
                ...
                <li className='nav-item'>
                    <Link className='nav-links' to="publications" onClick={closeMobileMenu} smooth={true} duration={500} spy={true} exact='true' offset={0} activeClass='active'>
                ...
                <li className='nav-item'>
                    <Link className='nav-links' to="contact" onClick={closeMobileMenu} smooth={true} duration={500} spy={true} exact='true' offset={0} activeClass='active'>
