  ...
  return (
    ...
    <div className="flex flex-col items-center w-5/6 bg-theme-secondary-black border-theme-dark-pink border-4 rounded-lg shadow-md md:flex-row">
        ...
        <div className="flex flex-col justify-between p-4 leadng-normal">
            <div className="font-bold text-xl md:text-2xl mb-2 text-theme-orange">{props.title}</div>
            <p className="mb-2 text-sm md:text-base text-theme-light-orange-yellow">{props.content}</p>
            <p className="mb-2 font-semibold text-sm md:text-base text-theme-orange">{props.publisher}</p>
