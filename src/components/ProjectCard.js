...
function ProjectCard({props}) {
  return (
        ...
        //     <div className="bg-theme-primary-font-color rounded-lg shadow-lg overflow-hidden p-8 w-3/5 -mr-12 ml-6 z-0">
        ...
        //         <div className="text-theme-orange p-0 mb-2 mt-6 w-full">
        //             <h2 className="text-2xl font-bold">{props.title}</h2>
        //         </div>
        //         <div className="bg-theme-secondary-black rounded-md shadow-lg  p-6 w-full h-fit !z-0 my-3">
        //             {props.content.map((item, index) => 
        //                 <p key={index + 1} className="mt-1 text-theme-light-orange-yellow">{item}</p>
        //             )}
        //         </div>    
        //         <ul className="flex text-theme-orange p-0 my-2 w-full h-fit">
        ...
        //             <h2 className="text-2xl font-bold">{props.title}</h2>
        //         </div>
        //         <div className="bg-theme-secondary-black rounded-md shadow-lg p-6 w-full z-0 my-3">
        //             {props.content.map((item, index) => 
        //                 <p key={index + 1} className="mt-1 text-theme-light-orange-yellow">{item}</p>
        //             )}
        //         </div>    
        //         <ul className="flex text-theme-orange p-0 my-2 w-full justify-end">
        //             {props.skills.map((item, index) => 
        ...
        <div className="flex items-stretch w-5/6 justify-center my-12">
            <div className="flex flex-col w-full md:w-2/4 justify-center">
                ...
                <div className="bg-theme-secondary-black rounded-md shadow-lg p-6 w-full !z-0 my-3 transform transition duration-500 hover:scale-105">
                    {props.content.map((item, index) => 
                        <p key={index + 1} className="mt-1 text-theme-light-orange-yellow text-sm md:text-base">{item}</p>
                    )}
                </div>    
                <ul className="flex text-theme-orange p-0 my-2 w-full !z-0">
                    {props.skills.map((item, index) => 
                        <li key={index + 1} className="mr-3 font-semibold text-sm bg-theme-secondary-black rounded-2xl py-1 px-2 md:text-base sm:bg-transparent sm:p-0">{item}</li>
                    )}
                </ul>
                <div className="overflow-hidden p-0 mt-2 w-full space-x-4">
                    {props.git !== undefined &&
        ...
        <div className="flex items-stretch w-5/6 justify-center my-12">
            ...
            <div className="flex flex-col w-full md:w-2/4 text-right justify-center">
                ...
                <ul className="flex text-theme-orange p-0 my-2 w-full justify-end !z-0">
                    {props.skills.map((item, index) => 
                        <li key={index + 1} className="ml-3 font-semibold bg-theme-secondary-black rounded-2xl py-1 px-2 text-sm md:text-base sm:bg-transparent sm:p-0">{item}</li>
                    )}
                </ul>
                <div className="overflow-hidden p-0 mt-2 w-full space-x-4">
                    {props.git !== undefined &&
